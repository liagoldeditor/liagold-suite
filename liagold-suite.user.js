// ==UserScript==
// @name         LiaGold Suite Ultimate (Totalizer + Scanner + ERP Footer)
// @namespace    liagold.suite.ultimate
// @version      1.0.20
// @description  v1.0.20: Unified Suite - Totalizer, Scanner, and Purchasing Footer Totals
...
(function () {
  ...
  // ==========================================
  // MODULE 1: Gold ERP - Total Bawah Tabel
  // ==========================================
  (() => {
    ...
    function isTargetTable(table) {
      return !!table.querySelector(
        'th.mat-column-purchasePrice, td.mat-column-purchasePrice, th.cdk-column-purchasePrice, td.cdk-column-purchasePrice'
      );
    }
  ...
  // ==========================================
  // MODULE 2: LiaGold Suite (Totalizer + Scanner)
  // ==========================================
  (function () {
    'use strict';
